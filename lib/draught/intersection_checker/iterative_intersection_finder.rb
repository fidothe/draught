...
module Draught
  class IntersectionChecker
    class IterativeIntersectionFinder
      ...
      def self.check(world, curve_1, curve_2)
        new(world, curve_1, curve_2).check
      end
      ...
      def check
        if both_curves_flat?
          IntersectionChecker::Line.check(world, curve_1.line, curve_2.line)
        else
